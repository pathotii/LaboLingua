...
class _AddNoteViewState extends State<AddNoteView> {
  ...
  Future<void> _saveNote() async {
    ...
    try {
      ...
      // Step 3: Prepare the note object to save in Firestore
      final note = {
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          _buildTextField(
                              _definitionFilipinoController,
                              'Depinisyon sa wikang Filipino',
                              Icons.bookmark),
  ...
  Widget _buildFilePicker() {
    return Container(
      ...
      child: ElevatedButton(
        onPressed: () async {
          await _selectAndUploadAudioFile();

          // After the file is uploaded, you can check the result
          if (_filePath != null && _filePath!.isNotEmpty) {
            ScaffoldMessenger.of(context).showSnackBar(
              const SnackBar(
            ...
            ScaffoldMessenger.of(context).showSnackBar(
              const SnackBar(content: Text('Failed to upload audio file.')),
            );
          }
        },
        ...
        child: const Row(
          ...
          children: [
            ...
            SizedBox(width: 10),
            Text('Pumili ng mp3 or m4a file (optional)',
