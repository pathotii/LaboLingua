...
class TeacherPambansa extends StatefulWidget {
  final String category;
  const TeacherPambansa({super.key, required this.category});

  @override
  State<TeacherPambansa> createState() => _TeacherPambansaState();
}

class _TeacherPambansaState extends State<TeacherPambansa> {
