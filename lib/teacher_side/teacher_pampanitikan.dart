...
class TeacherPampanitikan extends StatefulWidget {
  final String category;

  const TeacherPampanitikan({super.key, required this.category});

  @override
  State<TeacherPampanitikan> createState() => _TeacherPampanitikanState();
}

class _TeacherPampanitikanState extends State<TeacherPampanitikan> {
