...
import 'teacher_view_for_deletion.dart';

class ApprovedWordsView extends StatefulWidget {
  const ApprovedWordsView({super.key});

  @override
  State<ApprovedWordsView> createState() => _ApprovedWordsViewState();
}

class _ApprovedWordsViewState extends State<ApprovedWordsView> {
  String _searchQuery = '';
  final TextEditingController _searchController = TextEditingController();
  List<Map<String, dynamic>> approvedWords = [];
  ...
  Future<void> _loadApprovedWords() async {
    try {
      ...
      approvedWords = querySnapshot.docs
          .map((doc) => doc.data() as Map<String, dynamic>)
          .toList();

      // Print the fetched data for debugging
      for (var word in approvedWords) {
        print(word);
      }
  ...
  Widget build(BuildContext context) {
    final filteredWords = approvedWords.where((item) {
              ...
              Expanded(
                child: _isLoading // Show loading indicator while fetching data
                    ...
                    : capitalizedItems.isEmpty
                        ? const Center(child: Text('No approved words'))
                        : ListView.builder(
