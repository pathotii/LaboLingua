...
class TeacherKolokyal extends StatefulWidget {
  final String category;

  const TeacherKolokyal({super.key, required this.category});

  @override
  State<TeacherKolokyal> createState() => _TeacherKolokyalState();
}

class _TeacherKolokyalState extends State<TeacherKolokyal> {
  ...
  Future<void> _fetchApprovedWords() async {
    try {
      QuerySnapshot querySnapshot = await FirebaseFirestore.instance
          ...
          .where('category',
              isEqualTo: 'Kolokyal') // Only Kolokyal category
          .get();
