...
class Balbal extends StatefulWidget {
  final String category;

  const Balbal({super.key, required this.category});

  @override
  State<Balbal> createState() => _BalbalState();
}

class _BalbalState extends State<Balbal> {
  final List<Map<String, String>> _preSavedItems = [
    ...
    },
    {
      ...
      'audio': 'assets/audio/Nguraol B_20241123_202138.mp3',
      'subcategory': 'Pandiwa'
    },
    {
      'word': 'maragamo',
  ...
  Future<void> _fetchApprovedWords() async {
    try {
      ...
      if (querySnapshot.docs.isEmpty) {
        print("No approved Balbal words found.");
      }
      ...
      print('Error fetching approved Balbal words: $e');
    }
  }
                            ...
                            child: Container(
                              ...
                              child: ListTile(
                                ...
                                onTap: () {
                                  ...
                                  print(
                                      "Definition Labo: ${item['definitionLabo']}");
                                  print(
                                      "Definition Filipino: ${item['definitionFilipino']}");
                                  print(
                                      "Definition English: ${item['definitionEnglish']}");
                                  print("Category: ${widget.category}");
                                  print("Audio File Path: ${item['audio']}");
